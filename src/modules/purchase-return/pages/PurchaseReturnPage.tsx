...
export const PurchaseReturnPage = () => {
  ...
  const handleCreate = async (formData: CreatePurchaseReturnInput) => {
    try {
      ...
      toast.error(err?.data?.message || "Failed to create purchase return");
    }
  };
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="font-mono text-sm text-muted-foreground">
          {row.original.purchaseInvoiceNumber}
        </span>
      ),
    },
    {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage purchase returns</p>
        </div>
      ...
      <FormModal
        ...
        description="Return items from a purchase"
        className="sm:max-w-[800px]"
      >
        <PurchaseReturnForm onSubmit={handleCreate} isLoading={isCreating} />
      </FormModal>
            ...
            <div className="space-y-4 mt-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium">{detailReturn.purchaseInvoiceNumber}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {typeof detailReturn.supplierId === "object"
                      ? detailReturn.supplierId.name
                      : detailReturn.supplierId}
                  </p>
                </div>
              </div>
              <Separator />
